...
export default function KnownFor() {
  ...
  return (
    ...
    >
      ...
      {/* Highlights Grid */}
      <div className="grid md:grid-cols-2 gap-10 max-w-5xl w-full relative z-10">
        {highlights.map((item, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-neutral-900/60 border border-neutral-800 rounded-2xl p-6 text-left hover:border-yellow-400/40 transition duration-300 shadow-[0_0_25px_rgba(250,204,21,0.05)]"
          >
